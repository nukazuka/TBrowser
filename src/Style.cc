...
TStyle* Style()
{
   ...
   TStyle *tmpStyle = new TStyle("Sample", "Sample Style");
   ...
   tmpStyle->SetOptDate(kTRUE); //edited
   tmpStyle->SetOptStat(1111);
   tmpStyle->SetOptTitle(kTRUE);
   tmpStyle->SetOptFit(kTRUE); //edited
   ...
   tmpStyle->GetAttDate()->SetTextColor(kGray+1); //edited
   tmpStyle->SetDateX(0.005); //edited
   tmpStyle->SetDateY(0.005); //edited
   tmpStyle->SetEndErrorSize(2);
   tmpStyle->SetErrorX(0.5);
   tmpStyle->SetFuncColor(2);
   tmpStyle->SetFuncStyle(1);
   tmpStyle->SetFuncWidth(2);
   tmpStyle->SetGridColor(kGray); //edited
   ...
   tmpStyle->SetHistLineColor(kBlack); // edited
   tmpStyle->SetHistFillStyle(1001);
   tmpStyle->SetHistLineStyle(1);
   tmpStyle->SetHistLineWidth(2); //edited
   tmpStyle->SetHistMinimumZero(kTRUE); //edited
   tmpStyle->SetCanvasPreferGL(kFALSE);
   tmpStyle->SetCanvasColor(0);
   tmpStyle->SetCanvasBorderSize(2);
   tmpStyle->SetCanvasBorderMode(0);
   tmpStyle->SetCanvasDefH(500); // to be edited
   tmpStyle->SetCanvasDefW(700); // to be edited
   ...
   tmpStyle->SetPadGridX(kTRUE); //edited
   tmpStyle->SetPadGridY(kTRUE); //edited
   tmpStyle->SetPadTickX(kTRUE); //edited
   tmpStyle->SetPadTickY(kTRUE); //edited
   ...
   tmpStyle->SetStatX(0.98); // to be edited
   tmpStyle->SetStatY(0.935); // to be edited
   ...
   tmpStyle->SetTitleFontSize(0.05); // to be edited
